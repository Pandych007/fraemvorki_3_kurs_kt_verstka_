<!-- <template>
  <div>
    <h1>Binding & Derective example</h1>
    <DerectiveBind></DerectiveBind>
  </div>
  <div>
    <h2>text1</h2>
    <Post :title="'title #1'" :text="'text #2'"> </Post>
  </div>
</template>

<script>
import DerectiveBind from './components/DerectiveBind.vue'
...
<template>
  ...
  <div>
    ...
    <div class="post_wrapper">
      <Post v-for="item in posts" :key="item.id" :title="item.title" :text="item.text"></Post>
    </div>
  </div>
</template>
